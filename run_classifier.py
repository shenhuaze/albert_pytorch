...
def main():
    ...
    ## Required parameters
    parser.add_argument("--data_dir", default="dataset/CoLA/", type=str,
                        help="The input data dir. Should contain the .tsv files (or other data files) for the task.")
    parser.add_argument("--model_type", default="albert", type=str,
                        help="Model type selected in the list: ")
    parser.add_argument("--model_name_or_path", default="pretrained_models/albert_base_v2/", type=str,
                        help="Path to pre-trained model or shortcut name selected in the list")
    parser.add_argument("--task_name", default="cola", type=str,
                        help="The name of the task to train selected in the list: " + ", ".join(processors.keys()))
    parser.add_argument("--output_dir", default="outputs/cola/", type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--vocab_file", default='', type=str)
    parser.add_argument("--spm_model_file", default='pretrained_models/albert_base_v2/spiece.model', type=str)

    ## Other parameters
    parser.add_argument("--config_name", default="pretrained_models/albert_base_v2/config.json", type=str,
                        help="Pretrained config name or path if not the same as model_name")
    parser.add_argument("--tokenizer_name", default="", type=str,
                        help="Pretrained tokenizer name or path if not the same as model_name")
    parser.add_argument("--cache_dir", default="outputs/cola/", type=str,
